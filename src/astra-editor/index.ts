...
export class AstraEditor extends LitElement {
  ...
  protected firstUpdated(): void {
    ...
    this.extensions = [
      ...
      {
        name: "theme",
        ext: getPredefineTheme(
          this.color === "dark" ? "dark" : "light",
          this.theme
        ),
        comp: new Compartment(),
      },
  ...
  protected updated(properties: PropertyValues<this>): void {
    if (properties.has("color")) {
      ...
      this.updateExtension(
        "theme",
        getPredefineTheme(this.color === "dark" ? "dark" : "light", this.theme)
      );
    }
  ...
  registerKeymap(name: string, key: KeyBinding) {
    this.updateExtension(
      "custom-keybinding-" + name,
      Prec.highest(keymap.of([key]))
    );
  }
